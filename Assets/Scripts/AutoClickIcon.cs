...
public class AutoClickIcon : MonoBehaviour
{
    int Source;
    int Destination;
    float progress;
    ...
    void Start()
    {
        ...
        sizeMax = new Vector3(6.75f,6.75f,2f);

        source = transform.parent.position;
        Vector3 prod = GameObject.Find("PopRateValue").GetComponent<RectTransform>().position;
